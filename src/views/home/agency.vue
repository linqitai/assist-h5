		...
		<van-action-sheet v-model="showTipModel" title="问题小帮手">
			<div class="paddingWing">
				...
				<div class="tip4model4">
					...
					4.省市代理拥有给他人内排注册的权限。<br>					5.省市代理点对点(定向)交易免矿石上的手续费而收20%的帮扶券，代收请优先找省市代理，代收规则：比如省市代理A接到户主B的代收1000个矿石任务后，A先发广告从会员手中收零散的矿石（1个、2个、3个...），收到100个或者1000个后，再依次转给户主B。<br>
					6.省市代理拥有帮扶券的代理权。帮扶券的用处：用于帮助生活中遇到困难的会员、也可用于交易当作手续费等。<br>					<!-- 5.省市代理拥有帮扶券的代理权。帮扶券：用户之间点对点(定向)交易需用一个帮扶券，帮扶券由平台发放到区域代理再到省代理再到市代理再到用户。<br> -->					7.其他......	
					<div class="placeholderLine10"></div>
