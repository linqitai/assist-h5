		...
		<div class="agencyTabs">
			<van-tabs v-model="activeName" :background="$api.tabBgColor" :color="$api.tabActiveColor" :title-active-color="$api.tabActiveColor"
			 :title-inactive-color="$api.tabTextColor" :border="false" @change="tabChange" animated sticky>
						...
						<div class="list">
							<div class="item">
								...
								<div class="flex">
									...
									<div class="line letterSpacing lineHeight">有意向参与到志愿者队伍的会员们请找16号客服·志愿者管理做引荐</div>
								</div>
				...
				<van-tab title="现有志愿者" name="agency2">
					<van-list v-model="loading2" :finished="finished2" finished-text="没有更多了" @load="onLoad2">
						<div class="list" v-for="item in list2" :key='item.id'>
							<div class="item">
								...
								<div class="flex">
									...
									<div class="line">
										<div>
											...
											<i class="yellow"> 帮扶券 {{item.num}}个</i> 
								...
								<div class="flexRight">团算 {{item.teamCalculationPower}}G</div>
							</div>
		...
		<van-action-sheet v-model="showTipModel" title="问题小帮手">
			<div class="paddingWing">
				...
				<div class="tip4model4">
					...
					方案1.个人算力在【首页-排行榜】中的用户找现有代理或客服审核即赠送市代理名额。<br>
					方案2.优秀的团队长可以免费申请成为代理。<br>
	...
	export default {
		...
		methods: {
			...
			onLoad2(){
				...
				_this.$ajax.ajax(_this.$api.getIsAgentRanking, 'GET', params, function(res) {
