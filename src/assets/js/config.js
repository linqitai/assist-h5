export default{
	...
	contributeTypeOptions:[{id:0,value:'实名认证审核通过'},{id:1,value:'直推实名成功后'},{id:2,value:'买入'},{id:3,value:'卖出'},{id:4,value:'建议被采纳'},{id:5,value:'问题反馈成功'},{id:6,value:'购物'},{id:7,value:'租赁矿机'},{id:8,value:'交易权兑换'},{id:9,value:'分享任务奖励'},{id:10,value:'交易取消'},{id:11,value:'有效留言'},{id:12,value:'完成租赁矿机任务'},{id:13,value:'签到'}],
	platformTicketBookTypeOptions:[{id:0,value:'转入'},{id:1,value:'修改信息'},{id:2,value:'第一次租赁矿机'},{id:3,value:'卖出使用服务费'},{id:4,value:'取消交易'},{id:5,value:'竞选省代理获得'},{id:6,value:'竞选市代理获得'},{id:7,value:'转出'},{id:8,value:'津贴奖励'},{id:9,value:'内排注册'},{id:10,value:'留言'}],
	...
	machineTagOptions:[{id:0,value:'购买'},{id:1,value:'奖励'},{id:2,value:'赠送'},{id:3,value:'内排赠送'}],
	...
	calculationOptions:[{id:0,value:'自己租赁矿机'},{id:1,value:'直推租赁矿机'},{id:2,value:'自己矿机过期'},{id:3,value:'直推矿机过期'}],
	provinceOptions:[{
		"ProID": 1,
		"name": "北京市",
		"ProSort": 1,
