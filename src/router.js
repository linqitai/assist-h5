			...
			children: [{
					...
					children:[
						...
						},
						{
							path: '/game10242',
							name: '2048竞技区(倒计时模式)',
							component: resolve => require(['./views/home/game10242'],resolve),
							meta:{footer:false,keepAlive:true},
						},
						{
							path: '/game1024',
				...
				},
				{
					...
					meta:{footer:true,question:true,questionName:'mill',showMillRecordIcon:true,keepAlive:true},
				},
				{
					path: '/deal',
					name: '流通中心',
		...
		},
		{
			...
			children: [
				...
				},
				{
					...
					meta:{footer:false,back:true,question:false,keepAlive:false},
				},
				{
					path: '/helpRecord',
					name: '帮扶历史',
