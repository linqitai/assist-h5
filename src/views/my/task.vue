		...
		<div class="box share">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					...
					群里至少要有一半会员完成修改群昵称格式：HPC~自己昵称<br>
					需省市代理审核群昵称及群活跃度并引荐给客服再审核观察一周<br>
					群管理必须是群主的下级团队成员，或者是群主的上级，群主的团队算力不得低于10G<br>
					达标后：<br>
					群主和群管理各获得<span class="yellow">一台半年产30个矿石的小型矿机,需要先升级成工会会长然后启动该矿机</span>，申请该奖励需要写纸质版的申请书，群主和群管理4个人各一份<br>
		...
		<div class="box activity">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					...
					1.从2020/03/31开始统计，自己新增的直推累计100人实名，他们的直推累计200人实名，获得半年产50个矿石的小矿机一台!<br>
					2.从2020/03/31开始统计，自己新增的直推累计300人实名，他们的直推累计700人实名，获得半年产50个矿石的小矿机二台!<br>
		...
		<div class="box level">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					成为黄金级工会会长<br>
					需要：<br>
					1.团队算力达到500G并有效直推至少100个<br>
					或团队算力达到500G并个人算力达到33.4G<br>
					2.需培养3个白银(直推)<br>
					完成后:<br>
					1.可获得一台中型矿机+智能烧茶壶一个<br>
		...
		<div class="box level">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					成为铂金级工会会长<br>
					需要：<br>
					1.团队算力达到2000G并有效直推至少200个<br>
					或团队算力达到2000G并个人算力达到133.4G<br>
					2.需培养3个黄金(直推)<br>
					完成后:<br>
					1.可获得一台中型矿机+华为荣耀30Pro5G手机一部<br>
		...
		<div class="box level">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					成为钻石级工会会长<br>
					需要：<br>
					1.团队算力达到10000G并有效直推至少300个<br>
					或团队算力达到10000G并个人算力达到133.4G<br>
					2.需培养3个铂金(直推)<br>
					完成后:<br>
					1.可获得一台中型矿机+10万帮扶券<br>
