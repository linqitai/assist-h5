		...
		<div class="box level">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					成为白银级工会会长<br>
					需要：<br>
					有效直推至少30个+团队算力达到100或个人算力达到8.4<br>
					完成后:<br>
					1.可获得一台小型矿机<br>
		...
		<div class="box level">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					成为黄金级工会会长<br>
					需要：<br>
					有效直推至少100个+团队算力达到500或个人算力达到33.4<br>
					完成后:<br>
					1.可获得一台中型矿机<br>
		...
		<div class="box level">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					成为铂金级工会会长<br>
					需要：<br>
					有效直推至少200个+团队算力达到2000或个人算力达到133.4<br>
					完成后:<br>
		...
		<div class="box level">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					成为钻石级工会会长<br>
					需要：<br>
					有效直推至少300个+团队算力达到10000或有效直推至少500个+个人算力达到133.4<br>
					完成后:<br>
