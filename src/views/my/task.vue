  ...
  <div class="realname">
	...
	<van-dialog v-model="showTipModel" title="问题小帮手" confirmButtonText="好的">
		<div class="paddingWing f-12 lineHeight tip4model2 textJustify">
			...
			<div class="placeholderLine10"></div>
			<div class="textIndent">
				Tip2：平台会不定期举办爱心帮扶筹，帮助经济上有困难的会长，大病求助款优先获得帮助，帮扶对象的年龄限制在24~65岁(需要医院证明，然后省市代理会亲自去拜访帮扶对象)；若是18周岁以上的学生，学费上有困难也可以得到帮扶链平台的帮助(需要家乡居委会的证明，然后省市代理会亲自去拜访帮扶对象)；帮扶对象由省市代理以及白银级以上的工会会长（包括白银）引荐。
			</div>
			<div class="placeholderLine10"></div>
			<div class="textIndent">
