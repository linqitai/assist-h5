	...
	<div class="taskList">
		<div class="box finishInfo" @click="toView('info')">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					...
					<!-- 1.赠送1台体验矿机<br> -->
					1.增加1点贡献值<br>
					2.每次签到加相应贡献值，连续签到30天，可获得1台体验矿机
				</div>
			</div>
			<div class="flexRight">
		...
		<div class="box finishInfo" @click="toView('buyMill')">
			<div class="flexLeft">
				...
				<div class="line text margT10">
					第二次租赁矿机<br>
					在获得(租赁矿机所需矿石数的10%)点贡献值的同时，额外奖励1点贡献值<br>
				</div>
			</div>
			<div class="flexRight">
	...
	<van-dialog v-model="showTipModel" title="问题小帮手" confirmButtonText="好的">
		<div class="paddingWing f-12 lineHeight tip4model2">
			...
			<div class="textIndent">
				Tip1：平台不定期会开放回收市场交易区高于溢价回收矿石，所回收的矿石都销毁处理。
			</div>
			<div class="placeholderLine10"></div>
			<div class="textIndent">
				Tip2:平台每个月会举办爱心帮扶筹，帮助经济上有困难的会长，大病求助款优先获得帮助，帮扶对象的年龄限制在24~65岁（需要医院证明，然后省市代理会亲自去拜访帮扶对象）;若是18岁以上的学生，学费上有困难也可以得到帮扶链平台的帮助（需要家乡居委会的证明，然后省市代理会亲自去拜访帮扶对象）；帮扶对象由省市代理以及黄金级以上的工会会长（包括黄金）引荐。
			</div>
			<div class="placeholderLine10"></div>
			<div class="textIndent">
				Tip3:另外，平台特意申明，为了维护所有用户的利益，为了打造去中心化的好平台，帮扶链所有用户的矿石数量都公开透明，人人可查，人人受全体会员的监管，平台方绝对不会也没机会在矿石上获取盈利，项目的建设以及价格都由市场用户的共识性所决定。还有在项目的建设、制度以及模式上每个用户都可以给平台留言提建议，客服会收集整理可行性方案，然后以投票的方式让全体工会会长共同决定，一切需求由半数以上工会会长认可后才进行研发与上线，帮扶链工会会全心全意为广大用户提供一个有价值的平台。
			</div>
		</div>
	</van-dialog>
  </div>
