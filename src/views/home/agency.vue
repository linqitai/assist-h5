		...
		<van-action-sheet v-model="showTipModel" title="问题小帮手">
			<div class="paddingWing">
				...
				<div class="tip4model4">
					...
					2.为了规范定向交易市场，只有省市代理拥有定向交易的权利（定向交易矿石和帮扶券），代收请找省市代理。<br>
					3.省市代理拥有引荐受帮扶对象的权利。<br>
					4.拍下省代理获赠一台大型矿机，拍下市代理获赠一台中型矿机。<br>
					5.其他......<br>
					<div class="placeholderLine10"></div>
					<b class="textBold">竞选省市代理的条件：</b><br>
					1.团队长优先且至少是青铜以上级别，若同一个代理有多个用户竞选，以团队算力决定竞选结果。<br>
					2.自由职业用户优先；若是上班族，工作不是非常忙，时常可以抽出时间的优先。<br>
					3.省代理需抵押7000个帮扶券，同时获赠一台大型矿机；市代理需缴纳3000个帮扶券，同时获赠一台中型矿机。<br>
					4.代理期一年，市代理要先等本省代理竞选完毕再开始竞选。
